...
public class ButtonPacketHandlerC2S implements IMessageHandler<ButtonPacketC2S, IMessage> {

	@Override
	public IMessage onMessage(ButtonPacketC2S message, MessageContext ctx) {
		...
		else if(te != null && te instanceof TileEntityEntityDetector)
		{
