...
public class EntityCharcoalPoisonFX extends EntityThrowable {
	...
	public EntityCharcoalPoisonFX(World world) {
		super(world);
	...
	public EntityCharcoalPoisonFX(World world, double x, double y, double z, EntityPlayer player) {
		this(world);
	...
	*/
	...
	public EntityCharcoalPoisonFX setMaxAge(int maxAge) {
		particleMaxAge = maxAge;
		return this;
	}
	
	public EntityCharcoalPoisonFX setGravity(float gravity) {
